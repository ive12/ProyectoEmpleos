                ...
                <div class="col-md-12">
                	...
                	<div class="panel panel-default">
                        <div class="panel-heading" align="center">
                            <b>[EMPLEADO]</b><div id="mensaje"></div>
                        </div>
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                               <!-- <li class="active">
                                    <a href="#tab_per" id="tabp" data-toggle="tab" tabindex="1"><b><i style="width: 16px" class="fa fa-users"></i> Personas</b></a>
                                </li>-->
                               
								 <li>								
                                    <a href="#tab_suc" data-toggle="tab" tabindex="3"><b><i style="width: 16px" class="fa fa-institution"></i> Empleo</b></a>
                                </li>
                            ...
                            <div class="tab-content">
								...
								<!--PERSONAL-->
                                <div class="tab-pane fade" id="tab_per"><br>
                                    <div class="col-md-4">
                                    ...
                                    <!-- Aqui deshabilite el de agregar personal
								...
								<!--SUCURSALES-->
								<div class="tab-pane fade in active" id="tab_suc"><br>
									 <div class="col-md-4">
                                        <select name="critBSuc" id="critBSuc" class="form-control">
                                            ...
                                            <!--<option value="bin2">Empleo</option>-->
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                   ...
                                   <!-- <div class="col-md-3" align="right">
                                        <button class="btn btn-primary btn-block btn-xs" data-toggle='modal' data-target='#addSucursal' ><i style="width: 16px" class="fa fa-suitcase"></i> Nuevo Empleo</button>
                                    </div>-->
                                    <br><br>
